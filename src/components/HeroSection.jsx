  ...
  return (
    <section className="lyt-section typ-hero-section">
      <div className="container">
        ...
        <h1 className="bs-heading typ-96 typ-gradient-1 typ-fnt2 typ-600 d-inline-block" data-aos="fade-up">Darlene Robertson</h1>
        <p className="bs-para typ-18 typ-300 max-1080">
        ...
        <h3 className="bs-heading typ-24 typ-300">Say hi &rarr;</h3>
      </div>
    </section>
  );
}
